...
function Supplier(props) {
  ...
  const fetch = async () => {
    const datas = await fetchAllFolder("SUPPLIER");
    setCustomers(datas);
    ...
    return (
      <div className="w-full relative min-h-[130px] px-14   pr-24 flex items-end pb-[17px]  justify-between   border-b-[1px]  border-white border-opacity-10">
        ...
        <div className="flex items-center space-x-2">
          <h3 className="ml-4 text-4xl font-bold">Fournisseurs</h3>
        </div>
        <div className="flex">
...
function ItemGestion({ item, indexType, handleClick = () => {} }) {
  return indexType == 0 ? (
    ...
    <div
      onClick={handleClick}
      className="flex w-full relative flex-1 cursor-pointer min-h-[40px] hover:bg-[#ffffff0a]  items-center  text-[15px] mt-2    py-2 text-[#ffffff6f]  border-b-2 border-white border-opacity-10 x-40"
    >
