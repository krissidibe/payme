...
function getCountryName(v) {
  const datasFilter = country.filter((item) => item.Phone.toString().toLowerCase().includes(v.toString()))
      ...
      <div className="flex flex-col w-full h-full ">
        ...
        >
          <div className="flex w-full mt-[48px]">
            <div className="w-full">
              ...
              <div className="grid w-full grid-cols-2 gap-[23px] mt-[25px] gap-x-4">
                ...
                <InputComponent
                  ...
                  error={checkValidation && data.externalName.length < 3 ? "Min. 3 caractères" : ""}
                  onChange={handleChange}
                  label="Nom & prénom * "
                  labelClassName="text-white/40 text-[14px]"
                ...
                <InputDropdownCountryComponent
                  label="Pays *"
                  error={checkValidation && data.country.length < 3 ? "Min. 3 caractères" : ""}
               ...
               <InputComponent
                  ...
                  error={checkValidation && data.externalEmail.length < 3 ? "Min. 3 caractères" : ""}
                  onChange={handleChange}
                  labelClassName="text-white/40 text-[14px]  "
                  label="Email * "
                  className="rounded-[14px] h-[40px] text-[14px] border-opacity-30  focus:border-[#ffffff]"
                ...
                <div className="grid w-full grid-cols-2 gap-6 ml-[62px]">
                  <InputComponent
                    name="poste"
                    value={data.poste}
                    error={checkValidation && data.poste.length < 3 ? "Min. 3 caractères" : ""}
                    onChange={handleChange}
                    label="Poste * "
                    labelClassName="text-white/40 text-[14px]  "
                    className="rounded-[14px] h-[40px] text-[14px] border-opacity-30 focus:border-[#ffffff]"
              ...
              <InputComponent
                ...
                <div className="grid w-full  grid-cols-1  ml-[62px]  leading-[13px]  gap-6">
                  <div className="flex flex-col pt-3 space-y-2 opacity-30">
                   ...
                   <p className="pb-2 ">Contact interne :</p> 
                   <p> Personne spécifique au sein d'une entreprise avec laquelle vous collaborez. C'est généralement un point de contact au sein de l'organisation cliente, facilitant la communication et la coordination des activités entre les deux entités.
                      </p>
                    </div>
            ...
            <div className="w-[340px]     xl:mt-[500px] mt-[500px] pb-24  gap-4   flex justify-center items-end">
              <ButtonComponent
                key={1}
                label={"Annuler"}
                handleClick={() => {
      ...
      <div className=" relative min-h-[130px] px-10 mr-36 ml-[100px]   pr-0 flex items-end pb-[17px]  justify-between   border-b-[1px]  border-white border-opacity-10">
        ...
        <div className="flex">
          {customerInfo!.id && (
            ...
            className="relative">
              <svg className="absolute top-[10px] z-50 left-[17px]" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
