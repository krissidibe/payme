...
function DropdownPlanningItemOption({className="",children}) {
  return (
    <Menu >
    ...
    <Menu.Items className=" absolute  top-[80px]  py-2  max-w-[205px] rounded-[12px] z-20 right-[70px]  text-white/80 flex flex-col justify-center w-full   bg-[#323232] ">
