...
function InputDropdownCountryComponent({
  iconClassName = "",
  labelClassName = "",
  className = "",
  label = "",
...
{   !openDrop &&       <input
            ...
            className={` bg-[#06060600] border-[1px]  placeholder:text-white ${placeholderOn ? "placeholder:opacity-100" : "placeholder:opacity-40"} text-white border-white border-opacity-10  px-4 outline-none w-full h-12 ${className}`}
            {...props}
          />}
        </div>
        <div
...
export default InputDropdownCountryComponent;
