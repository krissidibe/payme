...
<input
            ...
            className={` ${openDrop ? "opacity-0" : ""}  bg-[#06060600] border-[1px] ${error ? "border-[#F2AAA5]" : "border-white"}   placeholder:text-white ${placeholderOn ? "placeholder:opacity-100" : "placeholder:opacity-40"}   text-white   border-opacity-10  px-4 outline-none w-full h-12 ${className}`}
            {...props}
          />
